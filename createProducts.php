...
?>
<link rel="stylesheet" href="css/createpr.css">
<div class="container">
    <h1>Adicionar Produtos</h1>
    <div class="row justify-content-center">
        <form method="POST" class="col-6" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nameProduct" class="titulos">Nome Produto</label>
            ...
            <div class="form-group">
                <label for="descriptionProduct" class="titulos">Descrição do produto</label>
            ...
            <div class="form-group">
                <label for="priceProduct" class="titulos">Preço</label>
            ...
            <div class="form-group">
                <label for="image" class="titulos">Escolhar sua imagem</label>
