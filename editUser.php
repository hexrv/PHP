...
?>
<link rel="stylesheet" href="css/editaru.css">
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-6">
            <form method="post">
                ...
                <div class="form-group">
                    <label for="senha" class="titulos">Nova senha</label>
                ...
                <div class="form-group">
                    <label for="senhaConf" class="titulos">Confirme sua senha</label>
                ...
                <div class="form-group">
                    <label for="senhaAntiga" class="titulos">Digite sua senha antiga</label>
